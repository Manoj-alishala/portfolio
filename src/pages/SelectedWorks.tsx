...
const projects = [
  {
    ...
    stack: "Python / Streamlit / Meta Llama 3.3 (70B) / NVIDIA NIM API / Docker",
    description: "An intelligent conversational agent for CSV dataset exploration. Transforms natural language queries into executable Python data pipelines and Matplotlib charts in real-time, featuring collapsible reasoning traces and full code transparency.",
    links: { live: "https://data-analysis-agent-v.streamlit.app/", code: "https://github.com/Manoj-alishala/Data-Analysis-Agent" },
    image: "/p5.png",
    cta: "View Project"
  },
  {
    ...
    description: "An AI-powered application that analyzes candidate resumes against job descriptions using NLP — surfacing skill gaps and alignment scores. Features a RESTful API layer connecting the NLP backend with a React.js frontend for async processing and real-time feedback.",
    links: { live: "https://ai-resume-analyzer-rqnw.onrender.com", code: "https://github.com/Manoj-alishala/AI-Resume-Analyzer" },
    image: "/p1.png",
    cta: "View Project"
  },
  {
    ...
    description: "A full-stack vehicle marketplace with a secure Admin Dashboard for real-time inventory CRUD. Integrated WhatsApp & Click-to-Call APIs and Nodemailer email automation for instant transactional confirmations, reducing inquiry response time.",
    links: { live: "https://manojcars.live", code: "https://github.com/Manoj-alishala" },
    image: "./p3.png",
    cta: "View Project"
  },
  {
    ...
    stack: "Node.js / Express.js / Socket.io / WebRTC / React.js / MongoDB",
    description: "A secure real-time communication platform supporting one-to-one chat with request-acceptance model, group chat with dynamic room management, and voice chat/call capabilities via WebRTC — all backed by event-driven Socket.io messaging and MySQL persistence.",
    links: { live: "https://chat-application-zchp.onrender.com/", code: "https://github.com/Manoj-alishala/VChat" },
    image: "/p2.png",
    cta: "View Project"
  },
  {
    ...
    description: "A responsive and dynamic image search application powered by the Unsplash API. Features category browsing, infinite scrolling, dark/light mode toggles, and seamless pagination built entirely with vanilla JavaScript and Bootstrap.",
    links: { live: "https://pixfindr.vercel.app/", code: "https://github.com/Manoj-alishala/Pixfindr" },
    image: "/p6.png",
    cta: "View Project"
  },
  {
    ...
    description: "A dynamic movie discovery app integrating external REST APIs for asynchronous data fetching. Features real-time search, filtering, efficient state management for large datasets, and a modular component architecture ensuring scalability and cross-device responsiveness.",
    links: { live: "https://movie-app-e5vq.onrender.com/", code: "https://github.com/Manoj-alishala/Movie-app" },
    image: "/p4.png",
    cta: "View Project"
  },
];
...
const SelectedWorks = () => {
  ...
  }, [calculateAndRender, filteredProjects]);
  ...
  return (
    <section className="min-h-screen bg-black text-white font-sans relative">
      ...
      {/* Filter Tags */}
      <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 border-b border-white/20">
        <div className="max-w-7xl">
          <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-white/60 mb-4">Filter by Technology</p>
          <div className="flex flex-wrap gap-3">
            <button
              onClick={() => setSelectedFilter(null)}
              className={`px-4 py-2 text-sm font-semibold uppercase tracking-wider rounded-full transition-all duration-300 ${selectedFilter === null
                ? "bg-white text-black"
            ...
            {allTechTags.map((tag) => (
              <button
                ...
                className={`px-4 py-2 text-sm font-semibold uppercase tracking-wider rounded-full transition-all duration-300 ${selectedFilter === tag
                  ? "bg-white text-black"
                  : "bg-white/10 text-white hover:bg-white/20"
                  }`}
              >
          ...
          {selectedFilter && (
            <p className="text-xs text-white/50 mt-4">Showing {filteredProjects.length} of {projects.length} projects</p>
          )}
        </div>
      </div>
