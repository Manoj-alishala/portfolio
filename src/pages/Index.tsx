...
const CursorFollower = () => {
  ...
  useEffect(() => {
    const moveCursor = (e: MouseEvent) => {
      ...
      if (target && (target.closest("a, button, [role='button']") || target.tagName === "BUTTON" || target.tagName === "A")) {
  ...
  return (
    <motion.div
      className="fixed top-0 left-0 w-12 h-12 rounded-full pointer-events-none z-[9999] hidden lg:block mix-blend-difference bg-white/90 border border-white transition-transform duration-200 ease-out backdrop-blur-xs"
      style={{
        x,
        y,
        scale,
...
const SocialStrip = () => {
  const socials = [
    { label: "GitHub", href: "https://github.com/Manoj-alishala" },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/manojaelishala/" },
    { label: "Email", href: "mailto:a.manoj.career@gmail.com" },
  ];
  return (
    <motion.div
...
const MobileSocialStrip = () => {
  const socials = [
    { label: "Github", icon: Github, href: "https://github.com/Manoj-alishala" },
    { label: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/manojaelishala/" },
    { label: "Email", icon: Mail, href: "mailto:a.manoj.career@gmail.com" },
  ];
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
  ...
  return (
    <div className="min-h-screen relative bg-black selection:bg-white selection:text-black">
        ...
        <div className="z-10 grid grid-cols-1 md:grid-cols-12 w-full gap-4 mb-8 md:mb-0">
          ...
          >
            ...
            <p className="font-sans text-xs md:text-sm font-medium text-white leading-relaxed tracking-wide uppercase text-left">
              Designing, building, and optimizing end-to-end software solutions — from REST APIs & cloud services to AI-powered applications.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="relative z-20 w-full bg-transparent">
        ...
        <div id="blog" className="bg-white text-black relative z-20">
          <SectionReveal delay={0.1}>
            <BlogSection />
          </SectionReveal>
        </div>
