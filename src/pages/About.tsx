...
const About = () => {
  ...
  return (
    <section className="min-h-screen md:h-screen w-full bg-white text-black font-sans px-6 md:px-12 lg:px-16 overflow-y-auto md:overflow-hidden flex items-start md:items-center justify-center relative py-24 md:py-0">
